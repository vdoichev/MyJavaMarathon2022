...
class Day14Task3Test extends AbstractTest {
    ...
    @Test
    void normal() {
        File file = new File("src/Tests/resources/D14T2_1.txt");
    ...
    @Test
    void negativeAge() {
        File file = new File("src/Tests/resources/D14T2_2.txt");
    ...
    @Test
    void fileNotFound() {
        File file = new File("src/Tests/resources/D14T2_miss.txt");
        Task3.parseFileToObjList(file);
